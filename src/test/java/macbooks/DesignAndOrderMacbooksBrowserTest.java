...
public class DesignAndOrderMacbooksBrowserTest {
  ...
  public void testDesignAmacbookPage_HappyPath() throws Exception {
    ...
    buildAndSubmitAmacbook("Basic Macbook", "13IN", "BACK", "WIRD", "35WC", "08GR");
    clickBuildAnothermacbook();
    buildAndSubmitAmacbook("Another Macbook", "14IN", "NRML", "WRLS", "65WC", "16GR");
  ...
  private void assertDesignPageElements() {
    ...
    WebElement wrapGroup = browser.findElementByCssSelector("div.ingredient-group#screen");
    List<WebElement> wraps = wrapGroup.findElements(By.tagName("div"));
    assertEquals(2, wraps.size());
    assertIngredient(wrapGroup, 0, "13IN", "13.6 inch");
    assertIngredient(wrapGroup, 1, "14IN", "14.6 inch");
    
    WebElement proteinGroup = browser.findElementByCssSelector("div.ingredient-group#keyboard");
    List<WebElement> proteins = proteinGroup.findElements(By.tagName("div"));
    assertEquals(2, proteins.size());
    assertIngredient(proteinGroup, 0, "BACK", "Backlit");
    assertIngredient(proteinGroup, 1, "NRML", "Normal");

    WebElement cheeseGroup = browser.findElementByCssSelector("div.ingredient-group#mouse");
    List<WebElement> cheeses = proteinGroup.findElements(By.tagName("div"));
    assertEquals(2, cheeses.size());
    assertIngredient(cheeseGroup, 0, "WIRD", "Wired");
    assertIngredient(cheeseGroup, 1, "WRLS", "Wireless");

    WebElement veggieGroup = browser.findElementByCssSelector("div.ingredient-group#charger");
    List<WebElement> veggies = proteinGroup.findElements(By.tagName("div"));
    assertEquals(2, veggies.size());
    assertIngredient(veggieGroup, 0, "35WC", "35W charger");
    assertIngredient(veggieGroup, 1, "65WC", "65W charger");

    WebElement sauceGroup = browser.findElementByCssSelector("div.ingredient-group#ram");
    List<WebElement> sauces = proteinGroup.findElements(By.tagName("div"));
    assertEquals(2, sauces.size());
    assertIngredient(sauceGroup, 0, "08GR", "8 GB");
    assertIngredient(sauceGroup, 1, "16GR", "16 GB");
  }
